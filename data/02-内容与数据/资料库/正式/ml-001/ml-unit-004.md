---
content_unit_id: ml-unit-004
book_id: ml-001
topic_id: ml-core-001
chapter: 回归与优化
knowledge_points: [ml-linear-regression]
source_id: src-ocademy-ml
source_relative_path: open-machine-learning-jupyter-book/ml-fundamentals/regression/linear-and-polynomial-regression.ipynb
source_commit: b1a5645749b1e3ec9977693b01c662014b71cae5
license: CC-BY-4.0
source_url: https://press.ocademy.cc/ml-fundamentals/regression/linear-and-polynomial-regression.html
...
We should be familiar by now with the structure of the pumpkin data that we are examining. We can find it preloaded and pre-cleaned in this section's linear and polynomial regression.ipynb（请通过本页“官方章节”链接查看） file. In the file, the pumpkin price is displayed per bushel in a new data frame.  Make sure we can run these notebooks in kernels in Visual Studio Code.
...
Assignment - Create a regression model（请通过本页“官方章节”链接查看）
