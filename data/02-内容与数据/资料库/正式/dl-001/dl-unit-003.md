---
content_unit_id: dl-unit-003
book_id: dl-001
topic_id: dl-core-001
chapter: 线性网络
knowledge_points: [dl-linear-regression, dl-forward, dl-loss]
source_id: src-d2l-zh
source_relative_path: chapter_linear-networks/linear-regression.md
source_commit: e6b18ccea71451a55fcd861d7b96fddf2587b09a
license: Apache-2.0
source_url: https://zh.d2l.ai/chapter_linear-networks/linear-regression.html
attribution: 动手学深度学习（中文版） — Aston Zhang; Zachary C Lipton; Mu Li; Alexander J Smola; D2L.ai contributors
...
> 本单元依据 动手学深度学习（中文版） 的固定版本整理；阅读原文、插图与延伸练习请使用页面中的官方章节链接。

## 学习目标

完成本节后，你应能解释并应用：深度学习中的线性回归、前向传播、损失函数。

## 阅读重点

用线性网络理解训练流程；理解输入到预测值的计算过程；理解预测误差如何被量化
