---
content_unit_id: dl-unit-005
book_id: dl-001
topic_id: dl-core-001
chapter: 多层感知机
knowledge_points: [dl-mlp, dl-neuron, dl-activation]
source_id: src-d2l-zh
source_relative_path: chapter_multilayer-perceptrons/mlp.md
source_commit: e6b18ccea71451a55fcd861d7b96fddf2587b09a
license: Apache-2.0
source_url: https://zh.d2l.ai/chapter_multilayer-perceptrons/mlp.html
...
完成本节后，你应能解释并应用：多层感知机、人工神经元、激活函数。

## 阅读重点

理解隐藏层与非线性表示；理解加权求和与偏置；理解非线性变换的作用
