...
chapter: 机器学习基础与监督学习
knowledge_points: [ml-learning-task]
source_id: src-ocademy-ml
source_relative_path: open-machine-learning-jupyter-book/ml-fundamentals/ml-overview.ipynb
source_commit: b1a5645749b1e3ec9977693b01c662014b71cae5
license: CC-BY-4.0
source_url: https://press.ocademy.cc/ml-fundamentals/ml-overview.html
...
https://static-1300131294.cos.ap-shanghai.myqcloud.com/images/ml-fundamentals/ml-overview/class-reg.png
...
[ml-overview-iris](../assignments/ml-fundamentals/ml-overview-iris.ipynb)

[ml-overview-mnist-digits](../assignments/ml-fundamentals/ml-overview-mnist-digits.ipynb)
